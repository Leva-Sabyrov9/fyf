...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8350110594:AAG2NTwYI42RKPhWWORicT90efoEMRYqs4Q")
CHANNEL_ID = os.getenv("CHANNEL_ID", "-1002907497877")
ADMIN_ID = int(os.getenv("ADMIN_ID", "582959560"))
...
def create_main_keyboard():
    ...
    keyboard.add(
        ...
        KeyboardButton('Настройка получателя')
    )
    return keyboard
...
async def main():
    ...
    try:
        scheduler.start()
        # Используем infinity_polling вместо polling
